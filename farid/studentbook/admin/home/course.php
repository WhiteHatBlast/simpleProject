...
<div align="center">
<h1><b><font color="black">USER INFORMATION</font></b></h1>

 <table  bgcolor="#D8F6CE" style="width: 500px; height: 19px;" border="0" >
  <tbody>
  
  <td bgcolor="#5FF748">No
  <td bgcolor="#5FF748">Username
  <td bgcolor="#5FF748">Email

  <td bgcolor="#5FF748">Age
  <td bgcolor="#5FF748">Sex
  <td bgcolor="#5FF748">Country
  <td bgcolor="#5FF748">Ip Connection
...
$str = "<tr>                                        
        ...
        <td bgcolor=#D8F6CE style=font-family: Arial Black; font-size: 12px;>$data1</td>                
        <td bgcolor=#D8F6CE style=font-family: Arial Black; font-size: 12px;>$data2</td>
		<td bgcolor=#D8F6CE style=font-family: Arial Black; font-size: 12px;>$data3</td>

		<td bgcolor=#D8F6CE style=font-family: Arial Black; font-size: 12px;>$data5</td>                
        <td bgcolor=#D8F6CE style=font-family: Arial Black; font-size: 12px;>$data6</td>
		<td bgcolor=#D8F6CE style=font-family: Arial Black; font-size: 12px;>$data7</td>
        <td bgcolor=#D8F6CE style=font-family: Arial Black; font-size: 12px;>$data8</td>
        </tr>";
...
?>
  ...
  <?php
  echo "<h1><font color=brown>COURSE : $course</font></h1></br>";
}
...
?>
  ...
  <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
   ...
   <option type="text" value="Nothing" >Choose your course...</option>
...
<option type="text" value="OTHER" >OTHER</option>
   ...
   <input onclick="return confirm('Are you sure you want to proceed?')"  class="button_studentbook_style" type="submit" name="submit" value="Search"><br/>
</form>
