...
if(isset($_GET['logout'])){	
	...
	//Simple exit message
	$fp = fopen("log.html", 'a');
	fwrite($fp, "<div class='msgln'><i>User Cust ". $_SESSION['nickname2'] ." has left the chat session.</i><br></div>");
	fclose($fp);
	
	unset($_SESSION['nickname2']);
	header("Location: chatting.php"); //Redirect the user
}
...
<div id="wrapper2">
	...
	<div id="menu">
		<p class="welcome">Welcome, <b>Cust<?php echo $_SESSION['nickname2']; ?></b></p>
...
$(document).ready(function(){
	...
	$("#exit").click(function(){
		...
		if(exit==true){window.location = 'chatting.php?logout=true';}		
	});
});
</script>
<?php
